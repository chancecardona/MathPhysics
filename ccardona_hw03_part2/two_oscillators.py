...
##############################################################################
# ASSIGNMENT NAME: Homework 03 Part 2: Two Oscillators
# NAME: Chance Cardona 
# EMAIL: ccardona@mymail.mines.edu 
# DATE: 9/17/18
# DESCRIPTION: Numerically solves a system of 2 oscillators using eulers meth
# GRADING NOTES: 
...
def time_evolution(steps, finaltime):
    ...
    for n in range(0, steps):
        ...
        - k/m*oscillators[1][0][n]) * dt + oscillators[1][1][n]
...
def oscillator():
    ...
    plt.title("Two oscillators with time step={}".format(dt))
